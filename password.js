funtion ( generator ) {
    ...
    let value= "ABCDEFGHIGKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz1234567890!@#$%^&*()"
    let password= "";
    for (var i=0; i <= complexity; i++){
        password =password + value.charAt( Math.floor(Math.random()*Math.floor(value.legth-1)));
